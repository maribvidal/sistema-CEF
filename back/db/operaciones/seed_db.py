...
def insertar_datos(cursor):  
    ...
    insertar_usuario(20000001, 'Lucia', 'Fernandez', '11111111', '1990-01-01', 'lucia.fernandez@yopmail.com', 'pwd01','F', 1, cursor)
    insertar_usuario(20000002, 'Mateo', 'Ramirez', '22222222', '1991-02-02', 'mateo.ramirez@yopmail.com', 'pwd02','M', 1, cursor)
    insertar_usuario(20000003, 'Sofia', 'Diaz', '33333333', '1992-03-03', 'sofia.diaz@yopmail.com', 'pwd03','F', 1, cursor)
    insertar_usuario(20000004, 'Diego', 'Vega', '44444444', '1993-04-04', 'diego.vega@yopmail.com', 'pwd04','M', 1, cursor)
    insertar_usuario(20000005, 'Valentina', 'Rios', '55555555', '1994-05-05', 'valentina.rios@yopmail.com', 'pwd05','F', 1, cursor)
    insertar_usuario(20000006, 'Nicolas', 'Suarez', '66666666', '1995-06-06', 'nicolas.suarez@yopmail.com', 'pwd06','M', 1, cursor)
    insertar_usuario(20000007, 'Isabella', 'Castro', '77777777', '1996-07-07', 'isabella.castro@yopmail.com', 'pwd07','F', 1, cursor)
    insertar_usuario(20000008, 'Lucas', 'Molina', '88888888', '1997-08-08', 'lucas.molina@yopmail.com', 'pwd08','M', 1, cursor)
    insertar_usuario(20000009, 'Camila', 'Ortiz', '99999999', '1998-09-09', 'camila.ortiz@yopmail.com', 'pwd09','F', 1, cursor)
    insertar_usuario(20000010, 'Joaquin', 'Herrera', '10101010', '1999-10-10', 'joaquin.herrera@yopmail.com', 'pwd10','M', 1, cursor)
