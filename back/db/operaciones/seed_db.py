...
def insertar_datos(cursor):  
    # Crear usuarios
    insertar_usuario_verificado(12345678, 'Juan', 'Pérez', '123333333', '2004-10-10', 'juan.perez@example.com', "1234",'M', 1, cursor)
    insertar_usuario_verificado(87654321, 'María', 'Gómez', '45644444', '2008-07-10', 'maria.gomez@example.com', "5678",'F', 3, cursor)
    insertar_usuario_verificado(39674828, 'Ernesto', 'Garcia', '12345678', '1997-07-10', 'ernesto.garcia@example.com', "5678",'M', 2, cursor)
    insertar_usuario_verificado(32031512, 'Lourdes', 'Gonzales', '6543713241', '1992-07-05', 'lourdes.gonzales@example.com', "5678",'F', 2, cursor)
    insertar_usuario_verificado(34673342, 'Gaspar', 'Solari', '7325466314', '2008-07-10', 'gaspar.solari@example.com', "5678",'M', 1, cursor)
   
    # Admin de prueba
    insertar_usuario_verificado(110101010, 'Admin', 'Ejemplo', '12345678', '2000-01-01', 'admin@gmail.com', "5678",'M', 1, cursor)

    # Usuario de prueba
    insertar_usuario_verificado(101010101, 'Usuario', 'Ejemplo', '12345678', '2000-01-01', 'usuario@yopmail.com', "5678",'M', 3, cursor)

    # Agregar 10 usuarios nuevos
    insertar_usuario_verificado(20000001, 'Lucia', 'Fernandez', '11111111', '1990-01-01', 'lucia.fernandez@yopmail.com', 'pwd01','F', 3, cursor)
    insertar_usuario_verificado(20000002, 'Mateo', 'Ramirez', '22222222', '1991-02-02', 'mateo.ramirez@yopmail.com', 'pwd02','M', 3, cursor)
    insertar_usuario_verificado(20000003, 'Sofia', 'Diaz', '33333333', '1992-03-03', 'sofia.diaz@yopmail.com', 'pwd03','F', 3, cursor)
    insertar_usuario_verificado(20000004, 'Diego', 'Vega', '44444444', '1993-04-04', 'diego.vega@yopmail.com', 'pwd04','M', 3, cursor)
    insertar_usuario_verificado(20000005, 'Valentina', 'Rios', '55555555', '1994-05-05', 'valentina.rios@yopmail.com', 'pwd05','F', 3, cursor)
    insertar_usuario_verificado(20000006, 'Nicolas', 'Suarez', '66666666', '1995-06-06', 'nicolas.suarez@yopmail.com', 'pwd06','M', 3, cursor)
    insertar_usuario_verificado(20000007, 'Isabella', 'Castro', '77777777', '1996-07-07', 'isabella.castro@yopmail.com', 'pwd07','F', 3, cursor)
    ...
    insertar_usuario_verificado(20010111, 'a', 'a', '11111111', '1990-01-01', 'tucorreo@ymail.com', 'pwd01','F', 3, cursor)
    ...
    id_usuario = insertar_usuario_verificado(20010101, 'a', 'a', '11111111', '1990-01-01', 'tucorreo@yopmail.com', 'pwd01','F', 3, cursor)["data"]
