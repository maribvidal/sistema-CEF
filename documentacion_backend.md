...
| /clientes/(inst_clase_id)/validar_qr | POST | id_usuario | 404: No se encontró una reserva/instancia/clase <br> 409: La reserva expiró <br> 422: La clase aún no ha comenzado <br> 500: Error de servidor al consultar reservas <br> 200: Asistencia confirmada exitosamente. |
| /clientes/(inst_clase_id)/validar_dni | POST | usuario_dni | 404: Usuario/Reserva/Instancia no encontrada <br> 409: La reserva expiró <br> 422: La clase aún no ha comenzado <br> 500: Error de base de datos <br> 200: Asistencia confirmada exitosamente. |
...
| /reservas/individual/(usuario_id)/(inst_clase_id)/confirmar | POST | - | 400/401: La reserva ya había sido creada <br> 200: Reserva individual creada exitosamente. |
| /reservas/abonado/(usuario_id)/(clase_id)/confirmar | POST | - | 400/401: La consulta por instancias falló <br> 402/403: Alguna reserva ya había sido creada <br> 200: Reservas para abonado creadas exitosamente. |
...
| /metricas/plata_recaudada/con_fechas | GET | fecha_inicio, fecha_fin | 400: No hay información <br> 500: Error interno <br> 200: Se devuelve la plata recaudada en rango. |
...
| /profesores | POST | dni, nombre, apellido, telefono, genero, actividades | 400: La lista de actividades está vacía <br> 409: El DNI ya se encuentra registrado para un profesor <br> 500: Error listando DNIs o insertando el profesor <br> 200: Profesor creado con éxito. |
...
| /usuarios/RestablecerContrasena | POST | correo | 400: El correo electrónico es requerido <br> 401: Error interno de consulta <br> 200: Correo enviado con éxito mediante librería SMTP. |
