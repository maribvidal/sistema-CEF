...
def test_obtener_rol_por_id():
    ...
    print("Test obtener_rol_por_id:")
    print(obtener_rol_por_id(1))  # Debería devolver el rol con id 1
    print(obtener_rol_por_id(999))  # Debería devolver una tupla vacía o None
