...
def insertar_datos():
    insertar_usuario(12345678, 'Juan', 'Pérez', '01-01-2002', '123', 'juan.perez@example.com', 1234,'masculino')
    insertar_usuario(87654321, 'María', 'Gómez', '01-01-2002', '456', 'maria.gomez@example.com', 5678,'femenino')
    ...
    insertar_mensualidad('01-01-2024', '31-01-2024', 1)
    insertar_mensualidad('01-02-2024', '29-02-2024', 2)
